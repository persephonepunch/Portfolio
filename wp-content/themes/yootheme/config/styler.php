...
return [
    ...
    'section' => [
        ...
        'groups' => [
            ...
            'inverse' => [
                ...
                'navbar nav item line' => [
                    '@inverse-navbar-nav-item-line-mode',
                    '@inverse-navbar-nav-item-line-position-mode',
                    '@inverse-navbar-nav-item-line-slide-mode',
                    '@inverse-navbar-nav-item-line-*'
                ],
        ...
        'hover' => [
            ...
            'article' => '.uk-article',
            'background' => '.uk-background, .uk-background-muted, .uk-background-primary, .uk-background-secondary',
            'badge' => '.uk-badge',
            ...
            'grid' => '.uk-grid',
            'heading' => '.uk-heading-primary, .uk-heading-divider, .uk-heading-bullet, .uk-heading-line',
            'icon' => '.uk-icon',
            'iconnav' => '.uk-iconnav',
            'label' => '.uk-label',
        ...
        'inspect' => [
            ...
            'heading' => '.uk-heading-primary, .uk-heading-primary > *, .uk-heading-divider, .uk-heading-divider > *, .uk-heading-bullet, .uk-heading-bullet > *, .uk-heading-line, .uk-heading-line > *',
